...
The owner selected **OK Workbench** / `ok-workbench` and supplied its intended public repository. Earlier public-availability checks applied to the discarded `okf-workbench` name and are not evidence for this new name.

## Approved decisions

- [x] Product identity: **OK Workbench** / `ok-workbench`.
- [x] Intended public repository: <https://github.com/edoloughlin/ok-workbench>.
