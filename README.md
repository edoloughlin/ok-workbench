...
The workspace overview also has an opt-in, real-browser check suite (viewport, dark mode, keyboard/tablist, and dialog-focus behavior) that is not part of `npm test` or CI, since it downloads a Chromium build:
